    ...
    state.pedidos.forEach((pedido, index) => {
      ...
      card.innerHTML = `
        <div style="display:flex;justify-content:space-between;gap:8px;align-items:flex-start;">
          ...
          ${editing ? '<div style="background:#f59e0b;color:#fff;padding:4px 8px;border-radius:999px;font-size:11px;font-weight:800;">✏️ Em edição</div>' : ''}
        </div>
...
>>>>>>> a6ff0d73add5859d45fd67c75a060eb911ef3646
